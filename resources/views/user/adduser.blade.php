                 ...
                 <div class="bank_area" style=" ">
                       <div class="card-body" style="">
                        ...
                        <div class="text-center logo">
                            ...
                            <h4 class="font-size-18 mt-1"style="color:green;" >REGISTRATION</h4bank_area>
                        </div>
                            ...
                            @csrf
                                    ...
                                    <div class="form-area" >
                                         ...
                                         <div class="input-group auth-form-group-custom mb-3">
                                            ...
                                            <span class="input-group-text bg-primary bg-opacity-10 fs-16 " id="basic-addon3" style="font-size:12px!important;">
                                                <!--<i class="mdi mdi-account"></i>-->
                                                Sponser Id</span>
                                            <input type="text" class="form-control" name="sponsor_id"  id="sponsor_id" onchange="checkusername();" value="{{$user->member_id}}"  placeholder="Enter Sponser Id" aria-label="email" aria-describedby="basic-addon3" readonly>
                                        </div>
                                        <div class="input-group auth-form-group-custom mb-3">
                                    <span class="input-group-text bg-primary bg-opacity-10 fs-16 " id="basic-addon1" style="font-size:12px!important;">
                                        <!--<i class="mdi mdi-account"></i>-->
                                        Sponser Name</span>
                                    <input type="text" class="form-control" placeholder="Enter Name" aria-label="Name" value="{{$user->name}}" aria-describedby="basic-addon1" required readonly>
                                    <div class="text-danger">
                                        @error('name')
                                            <span>{{ $message }}</span>
                                        @enderror
                              ...
                              <div class="form-area" style="">
                                 ...
                                 <div class="input-group auth-form-group-custom mb-3">
                                    <span class="input-group-text bg-primary bg-opacity-10 fs-16 " id="basic-addon1"><i class="mdi mdi-phone"></i></span>
                                    <input type="text" class="form-control" name="confirm_phone" id="confirm_phone" placeholder="Confirm Phone No" aria-label="mobile_no" aria-describedby="basic-addon1" required pattern="^\d{10}$" maxlength="10" title="Please enter a 10-digit phone number" oninput="this.value=this.value.replace(/\D/g,'');">
                                 </div>
                              </div>
                     ...
                     <div class="card-bank details" style="">
                        ...
                        <div class="text-center pt-3 mobile">
                           <button class="btn btn-primary w-xl waves-effect waves-light" id="submit" onclick="onclicksys();" type="submit">Register</button>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-12">
