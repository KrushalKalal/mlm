            ...
            <div class="col-10 col-md-6 col-lg-4 col-xxl-3">
                <div class="card mb-0">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <div>
                                <a href="" class="logo-dark">
                                    <img src="{{ url('userimg.jpg') }}" alt="" height="20" class="auth-logo logo-dark mx-auto">
                                </a>
                                <a href="" class="logo-light">
                                    <img src="{{ url('userimg.jpg') }}" alt="" height="20" class="auth-logo logo-light mx-auto">
                                </a>
                            </div>
                        ...
                        <div class="p-2 mt-1">
                            <form method="POST" enctype="multipart/form-data" action="{{ route('logincheckuser') }}">
                            @csrf
                                <div class="input-group auth-form-group-custom mb-3">
                                    ...
                                    <input type="text" name="member_id" class="form-control" placeholder="Enter Member Id" aria-label="Member Id" aria-describedby="basic-addon1">
                                </div>
                                @error('member_id')
                                    <span>{{ $message }}</span>
                                @enderror
