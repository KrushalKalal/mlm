                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Offer Setting</a></li>
                            <li class="breadcrumb-item active">Offer Setting</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-bordered">
                        <h3 class="card-title">Offer Setting</h3>
                    </div>
                    <div class="card-body">
                    @if(isset($offer))
                    <form method="POST" enctype="multipart/form-data" action="{{ route('offer.update', $offer->id) }}">
                        ...
                        @method('PUT')
                    @else
                    <form method="POST" enctype="multipart/form-data" action="{{ route('store.offer') }}">
                        @csrf
                    @endif  
                            <div class="d-grid gap-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-lg-6">
                                        <input type="file" class="form-control" name="image" id="inputmask-4" required>
                        ...
                        <table id="datatable-fixedheader" class="table table-hover table-bordered table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->status}}</td>
                                    <td>
                                        <form action="{{ route('offer.toggleStatus', $data->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <a href="{{ route('offer.edit', $data->id) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-pen"></i>
                                        </a>

                                        <form action="{{ route('offer.destroy', $data->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
