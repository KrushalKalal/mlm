            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Active User List</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Active User List</a></li>
                                <li class="breadcrumb-item active">Active User List</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{route('activeusersearch')}}" method="Post">
                        @csrf
                        <div class="row">
                            <!-- Month Selection -->
                            <div class="col-md-5">
                 ...
                 <div class="col-md-2" style="padding-left:20px;">
                         <a href="{{ route('activeuser.export') }}" class="btn btn-success btn-sm">
