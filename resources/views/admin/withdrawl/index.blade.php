                ...
                <div class="card">
                    <div class="card-header">
                     ...
                     <div class="col-md-2" style="padding-left:20px;">
                         <a href="{{ route('withdrawl.export') }}" class="btn btn-success btn-sm">
                            ...
                            <table class="table align-middle table-nowrap" id="">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                @php
                                                    $datasum = \App\Models\membersincome::where("member_id", $data->member_id)->sum("income");
                                        ...
                                        <td>
                                            @php
                                                $datataxamount = DB::table('cashbacks')->first();
                                                if($datasumget != 0)
                                                {
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <button class="btn btn-sm btn-primary" onclick="addamount({{ $data->id }})"><i class="fas fa-arrow-up"></i> Add Pay</button>
                                            <button class="btn btn-sm btn-primary" onclick="lessamount({{ $data->id }})"><i class="fa fa-arrow-down"></i> Less Pay</button>
