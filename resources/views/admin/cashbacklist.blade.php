        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">CashBack Master</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">CashBack Master</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{route('cashbacklistsearch')}}" method="Post">
                        @csrf
                                    ...
                                    @foreach($user as $data)
                                             ...
                                             <?php
                                               if($data->package_id != null)
                                               {
                                                   ...
                                                   $users = DB::table('users')->where('member_id',$data->member_id)->first();
                                               } 
                                            ?>
